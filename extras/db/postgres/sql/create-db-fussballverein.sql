...
--         chown postgres:postgres /var/lib/postgresql/tablespace/fussballverein
--         exit
--     docker compose down
...
-- (5) 2. PowerShell:
--     docker compose exec postgres bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-fussballverein.sql
--        psql --dbname=fussballverein --username=fussballverein --file=/sql/create-schema-fussballverein.sql
--        exit
--     docker compose down

-- https://www.postgresql.org/docs/current/sql-createrole.html
CREATE ROLE fussballverein LOGIN PASSWORD 'p';
