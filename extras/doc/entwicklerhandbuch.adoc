...
== Der Microservice Fussballverein
...
."FussballvereinGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,FussballvereinGetController,svg]
----
include::./FussballvereinGetController.plantuml[]
----

.Die Klasse "FussballvereinModel" für den Datenaustausch bei GET
[plantuml,FussbalvereinModel,svg]
----
include::./FussballvereinModel.plantuml[]
----

."FussbalvereinWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,FussbalvereinWriteController,svg]
----
include::./FussballvereinWriteController.plantuml[]
----
...
.Die Service-Klasse "FussbalvereinReadService" für die Geschäftslogik
[plantuml,FussbalvereinReadService,svg]
----
include::./FussballvereinReadService.plantuml[]
----

bla bla

.Die Service-Klasse "FussbalvereinWriteService" für die Geschäftslogik
[plantuml,FussbalvereinWriteService,svg]
----
include::./FussballvereinWriteService.plantuml[]
----
...
.Die Entity-Klasse "Fussbalverein" für Fussbalvereindaten
[plantuml,Fussbalverein,svg]
----
include::./Fussballverein.plantuml[]
----
