...
| datasource.url | string | `"jdbc:postgresql://localhost/fussballverein"` |  |
| datasource.username | string | `"fussballverein"` |  |
...
| image.name | string | `"fussballverein"` | Name des Image |
...
| logLevel.application | string | `"info"` | Loglevel für fussballverein als Umgebungsvariable |
